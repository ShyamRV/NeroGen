...
const ResearchPage: React.FC = () => {
  return (
    <div className="flex flex-col bg-bg-primary">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-30">
          <div className="max-w-4xl">
            ...
            >
              ...
              <span className="text-white/30 text-[10px] font-mono uppercase font-bold tracking-widest">Linguistic Logic Stacks</span>
            </motion.div>
            ...
            >
              Investigating the unique semantic structure of Indic languages to build 
              models that reason with cultural and contextual precision.
            </motion.p>
      ...
      {/* Global Impact / Citations Footer */}
      <section className="py-40 container mx-auto px-6 lg:px-12">
        <div className="border-t border-white/5 pt-32">
          <div className="flex flex-col lg:flex-row gap-24">
            <div className="lg:w-1/3">
              <h3 className="text-5xl font-black text-white uppercase tracking-tighter mb-10 leading-none">Global <br /> Publications.</h3>
              <p className="text-xl text-text-secondary opacity-60 mb-12 font-medium">Peer-reviewed experimental systems and benchmarks released under open licenses.</p>
            ...
            <div className="lg:w-2/3 space-y-6">
              {[
                'BH-PAPER-01: Multi-modal Alignment for Hindi Semantics',
                'BH-PAPER-04: Synthetic Corpus Generation in Air-Gapped Systems',
                'BH-PAPER-07: Low-Compute Reasoning in Vernacular Transformers',
                'BH-PAPER-12: Zero-Knowledge Privacy in Public Infrastructure'
              ].map((p, i) => (
