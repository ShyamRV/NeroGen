  ...
  return (
    <div className="flex flex-col bg-bg-primary">
      <header className="container mx-auto px-6 lg:px-12 py-32 max-w-5xl">
        <span className="text-[10px] font-mono text-accent-blue uppercase font-black tracking-widest block mb-8">Specialized Platforms</span>
        <h1 className="text-6xl lg:text-9xl font-black text-white tracking-tighter uppercase mb-12 leading-[0.85]">Strategic <br /> <span className="text-white/10">Systems.</span></h1>
        <p className="text-3xl text-text-secondary leading-tight font-medium opacity-60">
          Providing high-fidelity foundations for organizations building secure and 
          accountable intelligence platforms.
        </p>
      </header>
      ...
      <div className="flex flex-col">
        <ServiceSectionItem 
          ...
          tagline="Sovereign Strategic Infrastructure"
          desc="Resilient intelligence platforms architected for institutional situational awareness and mission-critical accountability."
          img={ASSETS.DEFENCE}
          icon={ShieldAlert}
        ...
        <ServiceSectionItem 
          ...
          tagline="Autonomous Operational Frameworks"
          desc="Precision intelligence stacks designed for industrial automation, autonomous logistics, and robotic actuation in complex environments."
          img={ASSETS.ROBOTICS}
          icon={Bot}
          accent="accent-cyan"
        ...
        <ServiceSectionItem 
          ...
          tagline="Foundational Health Sciences"
          desc="Precision genomic and protein modeling infrastructure optimized for sovereign biological research and clinical interpretability."
          img={ASSETS.BIO_AI}
          icon={Dna}
      ...
      <div className="container mx-auto px-6 lg:px-12 py-48">
        <div className="p-24 bg-bg-secondary border border-white/5 rounded-3xl flex flex-col lg:flex-row items-center justify-between gap-16 relative overflow-hidden group">
          ...
          <div className="max-w-xl relative z-10">
            <h2 className="text-6xl font-black text-white uppercase tracking-tighter mb-8 leading-none">System <br /> Integration.</h2>
            <p className="text-xl text-text-secondary opacity-60 mb-12 leading-relaxed">Strategic assessment for long-term initiatives in national security, deep-tech research, and industrial automation.</p>
